...
public class EditAttendActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = intent.getStringExtra(AttendEnglish.ENGLISH_ID1);
        String name = intent.getStringExtra(AttendEnglish.ENGLISH_NAME1);
    ...
    protected void onStart() {
        ...
        databaseAttend.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                AttendList attendListAdapter = new AttendList(EditAttendActivity1.this, attends);
    ...
    private void showAttendUpdateDialog(final String attendId, String attendDate, final String attendSub){
        ...
        editTextName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(EditAttendActivity1.this, date, myCalendar
